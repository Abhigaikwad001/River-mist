    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-[#FAF9F6] px-4 py-16">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl shadow-black/5 p-10 border border-[#D4AF37]/20 relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-serif text-[#1E3F20] font-bold">Create Account</h1>
          <p className="text-gray-600 mt-2">Join River Mist to book your perfect getaway</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          Already have an account? <a href="/auth/login" className="text-primary font-medium hover:underline">Log in</a>
        </p>
      </div>
    </div>
  );
